      ...
      <div className="bg-white rounded-lg border border-ink-100 overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-ink-100">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-display text-lg md:text-xl font-bold text-ink-900">
              {t.blog}
            </h2>
          </div>
          <Link
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4">
          {blogs.map(b => (
            <Link
              ...
              className="group rounded-lg border border-ink-100 overflow-hidden hover:shadow-hover transition"
            >
